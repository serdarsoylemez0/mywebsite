...
export function Footer() {
  return (
    <footer className="border-t border-gray-200 dark:border-gray-800 bg-white dark:bg-[#101922] mt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-10 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* About Section */}
          <div className="md:col-span-2">
            <h3 className="font-bold text-lg mb-4 text-gray-900 dark:text-white">{siteConfig.name}</h3>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/projects" className="text-gray-600 dark:text-gray-400 hover:text-primary transition-colors">
                  Projects
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/stats" className="text-gray-600 dark:text-gray-400 hover:text-primary transition-colors flex items-center gap-1">
                  <span>📊</span> Analytics
                </Link>
              </li>
            </ul>
